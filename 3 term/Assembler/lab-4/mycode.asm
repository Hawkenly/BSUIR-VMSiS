...
.data 
    ...
    curX            dw 0x0050h            ;current position 
    curY            dw 0x0017h            ;
    vectorX         dw -2h                ;move ball
    vectorY         dw -1h                ;
    points          dw 0x0000             ;current points                    
    max_coints      dw 0x0250                       
    points_str      db 10 dup(?)            
    LEN             dw 0                  ;size num score        
    score           db ' ',0Fh
...
logics: 
    begin:
     ...
     checkBorderX:              
        ...
        mov dx, [size_line]
        sub dx, [vectorX]        
        cmp [curX], dx           ;right border
        jge  changeVectorX      
        cmp [curX], 0            ;left border
        jle  changeVectorX  
     next:                       
        xor ax, ax  
        mov ax, [curY]          
